...
namespace Elysium
{
    ...
    public class ApiException : Exception
    {
        ...
        private static readonly IJsonSerializer _jsonSerializer = new NewtonsoftJsonSerializer();
        ...
        /// </summary>
        /// <remarks>Returns null if ApiError is not populated</remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Returns empty string if HttpResponse is not populated or if response body is not a string
        /// </remarks>
